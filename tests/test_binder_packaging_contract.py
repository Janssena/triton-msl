...
def policy():
    ...
    names = {'extension_default_mode', 'binder_extension_enabled',
             'validation_extension_enabled', 'packed_extension_enabled'}
...
def test_binder_default_does_not_break_other_python_native_builds(policy, mode, minor):
    ...
    assert policy['binder_extension_enabled'](
        default, 'cpython', (3, minor), 'darwin', 'arm64', False) is (mode != '0' and minor == 14)

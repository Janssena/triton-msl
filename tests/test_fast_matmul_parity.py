...
def mm(
    ...
    for k in range(0, K, BK):
        # These tensors have exact logical extents, not padded backing storage.
...
@pytest.mark.parametrize(
    "M,N,K", [(2048, 2048, 2048), (512, 512, 512), (256, 2080, 256), (256, 256, 264), (1024, 512, 256)]
)
...
@requires
@pytest.mark.parametrize("M,N,K", [(2048, 2048, 2048), (512, 512, 512), (256, 2080, 256), (1024, 512, 256)])

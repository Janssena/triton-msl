...
@pytest.mark.parametrize(
    "step,offset,masked", [(1, 0, False), (2, 0, False), (1, 3, False), (1, 0, True), (2, 3, True)]
)
def test_accumulator_bias_address_computes_source(step, offset, masked, executed):
    ...
    handle = _bias_dot[(1,)](a, b, bias, output, M=32, N=32, K=32, STEP=step, OFFSET=offset, MASKED=masked, num_warps=4)
